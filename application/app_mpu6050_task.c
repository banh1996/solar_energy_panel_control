...
static float accel_value = 0.0;   // Accelerometer corrector from raw data to "g"
static float gyro_value = 0.0;     // Gyroscope corrector from raw data to "degrees/s"
	...
	if (!TM_I2C_IsDeviceConnected(I2C3, MPU6050_I2C_ADDR)) 
  {
	...
	switch (accel_sensitivity)
	{
		case MPU6050_Accelerometer_2G:
			accel_value = (float)1 / MPU6050_ACCE_SENS_2; 
			break;
		case MPU6050_Accelerometer_4G:
			accel_value = (float)1 / MPU6050_ACCE_SENS_4; 
			break;
		case MPU6050_Accelerometer_8G:
			accel_value = (float)1 / MPU6050_ACCE_SENS_8; 
			break;
		case MPU6050_Accelerometer_16G:
			accel_value = (float)1 / MPU6050_ACCE_SENS_16; 
			break;
		default:
			break;
	}
	...
	switch (gyro_sensitivity) 
	{
		case MPU6050_Gyroscope_250s:
			gyro_value = (float)1 / MPU6050_GYRO_SENS_250;
			break;
		case MPU6050_Gyroscope_500s:
			gyro_value = (float)1 / MPU6050_GYRO_SENS_500; 
			break;
		case MPU6050_Gyroscope_1000s:
			gyro_value = (float)1 / MPU6050_GYRO_SENS_1000; 
			break;
		case MPU6050_Gyroscope_2000s:
			gyro_value = (float)1 / MPU6050_GYRO_SENS_2000; 
			break;
		default:
			break;
	}
